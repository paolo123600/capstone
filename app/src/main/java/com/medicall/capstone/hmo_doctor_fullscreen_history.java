...
public class hmo_doctor_fullscreen_history extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("Schedules").whereEqualTo("ClinicName", gv.getDoctor_HMO_ClinicName()).whereEqualTo("PatientUId", gv.getDoctor_HMO_PatientUId())
        ...
        download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(hmo_doctor_fullscreen_history.this);
                        ...
                        for(QueryDocumentSnapshot download : task.getResult()){
                            ...
                            ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    downloadFile(hmo_doctor_fullscreen_history.this, "PatientHMO" + download.getString("StorageId"), ".jpg", DIRECTORY_DOWNLOADS, url);
                                }
