...
import com.medicall.capstone.listeners.IRecyclerClickListner;
...
public class MyProductAdapter extends RecyclerView.Adapter<MyProductAdapter.MyViewHolder>{
        ...
        holder.setListner(new IRecyclerClickListner() {
            ...
            public void onClick(View view, int posistion) {
                BillingFlowParams billingFlowParams = BillingFlowParams.newBuilder()
                        .setSkuDetails(skuDetailsList.get(posistion))
                        .build();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setListner(IRecyclerClickListner listener) {
